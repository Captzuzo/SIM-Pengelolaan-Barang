<x-filament::page>
    <form wire:submit.prevent="generate" class="space-y-4">
        ...
        @if ($bulan && !empty($data['penjualans']))
        <a 
            href="{{ route('laporan-bulanan.cetak', ['bulan' => $bulan]) }}" 
            target="_blank" 
    ...
    <div class="mt-6 space-y-2">
        <h2 class="text-lg font-bold">Rekapitulasi Bulan {{ \Carbon\Carbon::parse($bulan)->translatedFormat('F Y') }}</h2>
